        ...
        <div class="col-xxl-4 col-lg-5">
            <div class="card">
                ...
                <div class="card-header py-4 text-center bg-primary">
                    <a href="index.html">
                        <span><img src="assets/images/logo-white.png" alt="logo" height="30"></span>
                    </a>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-center w-75 m-auto">
                        <h4 class="text-dark-50 text-center pb-0 fw-bold">Área do Cliente</h4>
                        <p class="text-muted mb-4">Entre com seu CPF ou CNPJ e Senha para acessar o Painel Administrativo.</p>
                    </div>
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <p class="text-muted">Ainda não é cadastrado? <a href="#" class="text-muted ms-1"><b>Contate-nos</b></a></p>
                </div> <!-- end col -->
            </div>
            <!-- end row -->
